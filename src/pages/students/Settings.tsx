                ...
                <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm p-10 space-y-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <select className="w-full bg-slate-50 border-none rounded-xl py-4 px-5 text-sm font-bold text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]/10 transition-all appearance-none cursor-pointer text-ellipsis overflow-hidden">
                          <option>
                    ...
                    <div className="space-y-6">
                      ...
                      <label className="flex items-start gap-4 cursor-pointer group">
                        <div className="relative flex items-center pt-0.5">
                          <input
                            type="checkbox"
                            className="peer h-5 w-5 cursor-pointer appearance-none rounded-md border-2 border-gray-200 transition-all checked:bg-[#1e3a8a] checked:border-[#1e3a8a]"
                      ...
                      <label className="flex items-start gap-4 cursor-pointer group">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs font-medium text-gray-400">
                            Allow other students to see your department and
                            enrollment status.
                          </p>
                        </div>
                      </label>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-10 border-b border-red-100/50">
                      <div className="space-y-2 max-w-xl">
                        ...
                        <p className="text-xs font-medium text-gray-500 leading-relaxed">
                          Archiving your account will disable your access to the
                          system and hide all your submitted complaints from
                          public view. This action can only be reversed by
