      ...
      <div className="page">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div className="flex-1 max-w-xl">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-white border border-gray-200 shadow-sm rounded-xl py-3 pl-11 pr-4 focus:outline-none focus:border-primary/30 focus:ring-4 focus:ring-primary/10 transition-all text-sm font-medium"
              />
            </div>
          </div>
          ...
          <Link
            ...
            className="btn-primary px-5 py-3 rounded-xl text-sm shadow-lg shadow-blue-900/20 shrink-0"
          >
            <UserPlus size={18} />
            Add New User
          </Link>
